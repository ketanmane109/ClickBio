...
pro_themes = {
    ...
    "frost-glass": {
        "bg": "bg-[url('https://images.unsplash.com/photo-1551008475-4533d141425b?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center before:absolute before:inset-0 before:bg-slate-900/50 before:backdrop-blur-xl", "fg": "text-slate-50",
    ...
    "crystal-blur": {
        "bg": "bg-[url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center before:absolute before:inset-0 before:bg-black/50 before:backdrop-blur-2xl", "fg": "text-white",
    ...
    "aurora-glass": {
        "bg": "bg-[url('https://images.unsplash.com/photo-1531366936337-7759a6857f35?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center before:absolute before:inset-0 before:bg-black/60 before:backdrop-blur-xl", "fg": "text-emerald-50",
    ...
    "liquid-glass": {
        "bg": "bg-[url('https://images.unsplash.com/photo-1550684376-efcbd6e3f031?q=80&w=2564&auto=format&fit=crop')] bg-cover bg-center before:absolute before:inset-0 before:bg-black/60 before:backdrop-blur-xl", "fg": "text-blue-50",
...
all_themes = {**free_themes, **standard_themes, **pro_themes}
