export const themeStyles: Record<string, { bg: string; fg: string; btn: string; btnHover: string; featured: string }> = {
  ...
  "cosmic-gradient": {
    bg: "bg-gradient-to-tr from-[#1a2a6c] via-[#b21f1f] to-[#fdbb2d]",
    fg: "text-orange-50",
  ...
  "purple-horizon": {
    bg: "bg-gradient-to-b from-[#4e54c8] to-[#8f94fb]",
    fg: "text-indigo-50",
  ...
  "dreamwave": {
    bg: "bg-gradient-to-br from-[#ff9a9e] via-[#fecfef] to-[#ffc3a0]",
    fg: "text-rose-950",
  ...
  "sunset-vibes": {
    bg: "bg-gradient-to-br from-[#f2709c] to-[#ff9472]",
    fg: "text-white",
  ...
  "peach-glow": {
    bg: "bg-gradient-to-br from-[#FFDAB9] to-[#F08080]",
    fg: "text-[#4A0E0E]",
...
export const FREE_THEMES = ["minimal-white", "soft-sky", "mint-clean", "warm-sunset", "simple-dark"];
export const STANDARD_THEMES = ["ocean-creator", "lavender-haze", "glass-creator", "midnight-blue", "peach-gradient", "aesthetic-beige", "creator-carbon", "frost-white", "cyber-violet", "soft-gold"];
export const PRO_THEMES = ["pearl-white", "black-diamond", "royal-gold", "platinum-glass", "ivory-elegance", "tiktok-creator", "youtube-creator", "instagram-elite", "gamer-stream", "podcast-studio", "artist-mode", "blush-pink", "mint-breeze", "lemon-chiffon", "lilac-dream", "frost-glass", "crystal-blur", "aurora-glass", "liquid-glass", "minimal-pro", "soft-neutral", "mono-space", "zen-white", "slate-minimal", "neon-matrix", "cyberpunk-x", "quantum-glow", "aurora-wave", "cosmic-gradient", "purple-horizon", "galaxy-flow", "dreamwave", "sunset-vibes", "ocean-breeze", "peach-glow"];
