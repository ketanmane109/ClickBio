    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-card p-6">
          ...
          <Button variant="outline" className="w-full mb-4 shadow-sm rounded-xl font-medium h-11 flex items-center justify-center gap-3 transition-all duration-200" onClick={handleGoogle}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {isLogin && (
              <p className="text-xs text-primary hover:underline cursor-pointer text-right -mt-7 pt-1" onClick={() => setShowForgotDialog(true)}>
                Forgot Password?
              </p>
            )}
