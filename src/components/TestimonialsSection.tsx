...
const testimonials = [
  { name: "Sarah K.", handle: "@sarahcreates", text: "BioSpark replaced 3 tools for me. My page looks incredible and it took 2 minutes to set up.", avatar: "🎨" },
    ...
    <section id="testimonials" className="py-24 bg-secondary/30">
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          ...
          <p className="text-muted-foreground">Join thousands building their brand with BioSpark.</p>
        </motion.div>
